...
namespace HackAtHome.CustomAdapters
{
	...
	public class EvidencesAdapter : BaseAdapter<Evidence>
    {
		...
		Activity Context; // Activity donde se utilizará este Adapter.
		int ItemLayoutTemplate; // Layout a utilizar para mostrar los datos de un elemento.
		int EvidenceTitleViewID; // ID del TextView donde se mostrará el nombre de la evidencia.
		int EvidenceStatusViewID; // ID del TextView donde se mostrará el estatus de la evidencia.

		/// <summary>
		/// Constructor para recibir la información que necesita el Adapter
		/// </summary>
		...
		/// <param name="evidenceTitleViewID">ID del TextView donde se mostrará el título de la evidencia.</param>
		/// <param name="evidenceStatusViewID">ID del TextView donde se mostrará el estatus de la evidencia.</param>

		public EvidencesAdapter(Activity context, List<Evidence> evidences, 
                                int itemLayoutTemplate, int evidenceTitleViewID, 
		...
		/// <summary>
		///  Devuelve el elemento de la lista localizado en la posición especificada.
		/// </summary>
		/// <param name="position">Posición del elemento dentro de la lista.</param>
		/// <returns></returns>
		...
		/// <summary>
		/// Devuelve el número de elementos de la lista.
		/// </summary>
		...
		/// <summary>
		/// Devuelve el ID del elemento localizado en la posición especificada.
		/// </summary>
		/// <param name="position">Posición del elemento dentro de la lista.</param>
		/// <returns></returns>
        ...
        /// </summary>
        /// <param name="position">Posición del elemento a mostrar.</param>
